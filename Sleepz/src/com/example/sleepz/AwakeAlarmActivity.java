...
public class AwakeAlarmActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_awake_alarm);

		getActionBar().setTitle("Awake Alarm");
		getActionBar().setDisplayHomeAsUpEnabled(true);

		timePicker = (TimePicker) findViewById(R.id.awake_alarm_timepicker);
		sleepEdit = (EditText) findViewById(R.id.awake_alarm_edit);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.awake_alarm, menu);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_save_sleep_alarm: {
			...
			Intent intent = new Intent(this, TimeSelectAwakeActivity.class);
