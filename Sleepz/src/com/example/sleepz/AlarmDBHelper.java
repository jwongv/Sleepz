...
public class AlarmDBHelper extends SQLiteOpenHelper {
	...
	// functions to move data from database to alarm model
	...
	//function to move data from model to database
	...
	//select alarm from database based of its ID
	...
	//update the alarm from the database
